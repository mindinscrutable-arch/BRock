  ...
  if (!translatedPrompt && !isLoading) {
    return (
      <div className="bg-[#111827] border border-gray-800 rounded-lg p-10 flex flex-col items-center justify-center text-center opacity-60 shadow-lg min-h-[300px]">
        ...
        <p className="text-sm text-gray-500 max-w-sm mt-2">Paste a Groq (LLaMA) or Vertex AI payload on the left and click translate to visually map the Google Vertex equivalent JSON structure.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#111827] border border-gray-800 rounded-lg p-5 flex flex-col gap-4 shadow-lg min-h-[450px]">
      ...
      <div className="grid grid-cols-2 gap-4 mt-2 h-full flex-1">
        ...
        <div className="flex flex-col gap-2 relative">
          <label className="text-[11px] uppercase tracking-wider text-green-400 font-bold drop-shadow-[0_0_4px_rgba(34,211,160,0.4)]">Translated Vertex Schema</label>
